...
mixin I18nMixin {
  static const _strings = {
    ...
    'storage_viewer.filter_keywords': ['filter keywords...', '筛选字词...'],
    'storage_viewer.type': ['Type', '类型'],
    'storage_viewer.key': ['Key', '键'],
    'storage_viewer.key_required': ['Key Required', '键必填'],
    'storage_viewer.value': ['Value', '值'],
    'storage_viewer.value_required': ['Value Required', '值必填'],
    'storage_viewer.value_must_double': ['Value Must Double', '值必须是Double类型'],
    'storage_viewer.value_must_bool': ['Value Must Bool', '值必须是Bool类型'],
    'storage_viewer.value_must_int': ['Value Must Int', '值必须是Int类型'],
    'storage_viewer.value_must_list_of_string': ['Value Must List<String>', '值必须是List<String>类型'],
    'storage_viewer.save': ['Save', '保存'],
